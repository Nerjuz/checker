...
if ($hash !== $cacheHash && count($response->data) > 0) {
    ...
    mail('nerjuz@gmail.com', 'Vejo dermatologas ['.date('Y-m-d H:i:s').']', date('Y-m-d H:i:s') . ' Yra laisvu laiku Vejui pas gyditoja: https://ipr.esveikata.lt/?municipality=7&profession=221210');
